package ua.nure.floristikup.util;
...
public class ValidationUtils {
    ...
    public static boolean verifyPasswords(Context context, EditText inputPassword, EditText inputConfirmPassword) {
        String password = inputPassword.getText().toString();
        String confirmPassword = inputConfirmPassword.getText().toString();
        if (password.equals(confirmPassword)) {
            return true;
        } else {
            inputConfirmPassword.setError(context.getString(R.string.passwords_tip));
            return false;
        }
    }
